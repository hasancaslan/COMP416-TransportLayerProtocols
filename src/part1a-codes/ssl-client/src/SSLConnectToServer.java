...
public class SSLConnectToServer {
    ...
    /**
     * Sends index as a integer over the secure channel and receives
     * character from the server
     *
     * @param index input index for character
     * @return response from server
     */
    public String SendForAnswer(int index) {
        try {
            os.write(index);
            os.flush();
            return is.readLine();
            ...
            e.printStackTrace();
            System.err.println("ConnectionToServer. sendIndexForCharacter. Socket read Error");
            return null;
        }
    }
